...
# unsigned long py_get_records(LAS *h, double *xy, double *z, int *c, int
# *pid, int *return_number, char *mask, unsigned long buf_size)
lib.py_get_records.argtypes = [
    ctypes.c_void_p,
    LP_CDOUBLE,
    LP_CDOUBLE,
    LP_CINT,
