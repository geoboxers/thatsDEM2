...
ARGS={"-debug":{"help":"Do a debug build.","action":"store_true"},
"-force":{"help":"Force a full rebuild.","action":"store_true"},
"-nonet":{"help": "No internet, so just build no matter what.", "action":"store_true"}
}
...
def main (args):
    ...
    if OLIB_TRI.needs_rebuild or OLIB_INDEX.needs_rebuild:
        ...
        if pargs.nonet:
            raise Exception("We need internet for this!")
