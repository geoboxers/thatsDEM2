...
void make_grid(double *base_pts,double *base_z, int *tri, float *grid, float *tgrid, float nd_val,
               int ncols, int nrows,
...
void make_grid_low(double *base_pts,double *base_z, int *tri, float *grid,  float nd_val, 
